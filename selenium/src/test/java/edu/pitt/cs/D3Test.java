...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    driver.manage().window().setSize(new Dimension(1420, 797));
    {
  ...
  public void tEST2RESET() {
    ...
    driver.findElement(By.linkText("Reset")).click();
    {
      ...
      wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@id=\'listing\']/ul/li")));
    }
  ...
  public void tEST3CATALOG() {
    ...
    {
      WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
      wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[2]/img")));
    }
    {
  ...
  public void tEST8FEEDACAT() {
    ...
    driver.findElement(By.linkText("Feed-A-Cat")).click();
    {
      ...
      wait.until(ExpectedConditions
          .visibilityOfElementLocated(By.xpath("//label[contains(.,\'Number of catnips to feed:\')]")));
    }
    {
